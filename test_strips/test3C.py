...
class PygletGridWindow(pyglet.window.Window):
    ...
    def create_grid(self):
        ...
        x_vals = np.linspace(-half_rect_w / self.width * 2, half_rect_w / self.width * 2, grid_w + 1)
        y_vals = np.linspace(-half_rect_h / self.height * 2, half_rect_h / self.height * 2, grid_h + 1)
